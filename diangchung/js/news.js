    ...
    function secondPageMobileAnimation(){
        let gg = gsap.timeline({
            scrollTrigger:{
        ...
        let gg2 = gsap.timeline({
            scrollTrigger:{
                trigger:".second-page-bottom ul > :nth-child(3)",
                start:"top 80%"
            }
        })
        let gg3 = gsap.timeline({
            scrollTrigger:{
                trigger:".second-page-bottom ul :nth-child(5)",
                start:"top 20%"
            }
        })
        gg.fromTo(".second-page-bottom ul > :nth-child(1)",{
        ...
        }).fromTo(".second-page-bottom ul > :nth-child(2)",{
            opacity:0,
            y:50
        },{
            y:0,
        ...
        gg2.fromTo(".second-page-bottom ul > :nth-child(3)",{
            opacity:0,
            y:50
        },{
            y:0,
        ...
        gg3.fromTo(".second-page-bottom ul > :nth-child(5)",{
            opacity:0,
            y:50
        },{
            y:0,
        ...
        }).fromTo(".second-page-bottom ul > :nth-child(6)",{
            opacity:0,
            y:50
        },{
            y:0,
    ...
    if(window.innerWidth >920){
        secondPageAnimation()
        console.lop("computer")
    }else{
        secondPageMobileAnimation()
        console.log("phone")
    }
